...
#if defined(ANDROID_NDK) || defined(__BORLANDC__) || (AX_TARGET_PLATFORM == AX_PLATFORM_BLACKBERRY)
#   include <ctype.h>
#   include <limits.h>
#   include <stdio.h>
#   include <stdlib.h>
...
#if (defined(_MSC_VER) && (_MSC_VER >= 1400 ) && (AX_TARGET_PLATFORM != AX_PLATFORM_MARMALADE))
...
*/
template< int SIZE >
class AX_DLL MemPoolT : public MemPool
{
public:
...
*/
class AX_DLL XMLText : public XMLNode
{
...
/** An XML Comment. */
class AX_DLL XMLComment : public XMLNode
{
    friend class XMLDocument;
public:
    virtual XMLComment*	ToComment()					{
...
*/
class AX_DLL XMLDeclaration : public XMLNode
{
    friend class XMLDocument;
public:
    virtual XMLDeclaration*	ToDeclaration()					{
...
*/
class AX_DLL XMLUnknown : public XMLNode
{
    friend class XMLDocument;
public:
    virtual XMLUnknown*	ToUnknown()					{
...
*/
class AX_DLL XMLElement : public XMLNode
{
    friend class XMLBase;
    friend class XMLDocument;
public:
...
*/
class AX_DLL XMLDocument : public XMLNode
{
    friend class XMLElement;
public:
    /// constructor
...
/**
	...
	@endverbatim
*/
class AX_DLL XMLPrinter : public XMLVisitor
{
public:
