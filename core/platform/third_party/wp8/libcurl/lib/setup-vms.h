...
#define getenv deAX_getenv
#ifdef __DECC
#   if __INITIAL_POINTER_SIZE != 64
#       define getpwuid deAX_getpwuid
#   endif
#endif
#include <stdlib.h>
...
#if __USE_LONG_GID_T
#   define deAX_getpwuid DECC$__LONG_GID_GETPWUID
#else
#   if __INITIAL_POINTER_SIZE
#       define deAX_getpwuid decc$__32_getpwuid
#   else
#       define deAX_getpwuid decc$getpwuid
#   endif
#endif

    struct passwd * deAX_getpwuid(uid_t uid);
...
/* Hack needed to support 64 bit builds, deAX_getpwnam is 32 bit only */
#ifdef __DECC
#   if __INITIAL_POINTER_SIZE
