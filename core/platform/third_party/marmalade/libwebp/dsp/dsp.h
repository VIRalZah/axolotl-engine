...
#if defined(_MSC_VER) && (defined(_M_X64) || defined(_M_IX86)) && (AX_TARGET_PLATFORM != AX_PLATFORM_MARMALADE)
#define WEBP_MSC_SSE2  // Visual C++ SSE2 targets
#endif

#if (defined(__SSE2__) || defined(WEBP_MSC_SSE2)) && (AX_TARGET_PLATFORM != AX_PLATFORM_MARMALADE)
