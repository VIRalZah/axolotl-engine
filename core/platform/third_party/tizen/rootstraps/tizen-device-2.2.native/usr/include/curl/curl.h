...
#define CURLE_FTP_AAXESS_DENIED CURLE_REMOTE_ACCESS_DENIED
...
typedef enum {
  CURLFTPSSL_CAX_NONE,    /* do not send CCC */
  CURLFTPSSL_CAX_PASSIVE, /* Let the server initiate the shutdown */
  CURLFTPSSL_CAX_ACTIVE,  /* Initiate the shutdown */
  CURLFTPSSL_CAX_LAST     /* not an option, never use */
} curl_ftpccc;
