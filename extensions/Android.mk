...
LOCAL_CFLAGS += -DAX_ENABLE_CHIPMUNK_INTEGRATION=1
LOCAL_EXPORT_CFLAGS += -DAX_ENABLE_CHIPMUNK_INTEGRATION=1
LOCAL_CPPFLAGS += -DAX_ENABLE_CHIPMUNK_INTEGRATION=1
LOCAL_EXPORT_CPPFLAGS += -DAX_ENABLE_CHIPMUNK_INTEGRATION=1
