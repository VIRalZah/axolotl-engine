 ...
 * pcal_purpose, pcal_units, pcal_params, hist, iPoint_name, iPoint_profile,
...
#ifdef PNG_iAXP_SUPPORTED
   /* iCCP chunk data. */
   png_charp iPoint_name PNG_DEPSTRUCT;     /* profile name */
   png_charp iPoint_profile PNG_DEPSTRUCT;  /* International Color Consortium profile data */
                            /* Note to maintainer: should be png_bytep */
   png_uint_32 iPoint_proflen PNG_DEPSTRUCT;  /* ICC profile data length */
   png_byte iPoint_compression PNG_DEPSTRUCT; /* Always zero */
#endif
...
#define PNG_INFO_iAXP 0x1000   /* ESR, 1.0.6 */
...
#ifdef PNG_EASY_AAXESS_SUPPORTED
...
#endif /* PNG_EASY_AAXESS_SUPPORTED */
...
#define PNG_iAXP png_byte png_iCCP[5] = {105,  67,  67,  80, '\0'}
...
/* Decompress data in a chunk that uses compression */
    ...
    defined(PNG_iAXP_SUPPORTED) || defined(PNG_sPLT_SUPPORTED)
...
#ifdef PNG_WRITE_iAXP_SUPPORTED
...
PNG_EXTERN void png_write_hIST PNGARG((png_structp png_ptr, png_uint_16p hist,
   int num_hist)) PNG_PRIVATE;
    ...
    defined(PNG_WRITE_iAXP_SUPPORTED) || defined(PNG_WRITE_sPLT_SUPPORTED)
...
#ifdef PNG_READ_iAXP_SUPPORTED
extern void png_handle_iCCP PNGARG((png_structp png_ptr, png_infop info_ptr,
   png_uint_32 length));
#endif /* PNG_READ_iAXP_SUPPORTED */
