...
#if defined(__MINGW32__) || defined(__POAX__)
...
#if !defined(__SALFORDC__) && !defined(__POAX__)
...
#if defined(__MINGW32__) || defined(__WATCOMC__) || defined(__LAX__) || \
    defined(__POAX__)
...
#if defined(__MINGW32__) || defined(__WATCOMC__) || defined(__POAX__)
...
#if defined(__POAX__) && (__POAX__ >= 500)
#  ifndef _WIN32_WINNT
...
#if defined(__POAX__) && defined(CURL_LDAP_WIN)
