...
void HelloCpp::OnBackButtonPressed(Object^ sender, BackPressedEventArgs^ args)
{
    ...
    // Director::sharedDirector()->getKeypadDispatcher()->dispatchKeypadMSG( ccKeypadMSGType::kTypeBackClicked );
    // args->Handled = true;
}
